...
type search_space = { 
    ...
    i_a_buy1  : int; i_b_buy1  : int;
    i_a_buy2  : int; i_b_buy2  : int;
    i_a_buy3  : int; i_b_buy3  : int;
    i_a_buy4  : int; i_b_buy4  : int;
    i_a_buy5  : int; i_b_buy5  : int;
    i_a_sell1 : int; i_b_sell1 : int;
    i_a_sell2 : int; i_b_sell2 : int;
...
let search_space_to_list x = [
    ...
    (BookAction(ST_Add((mk_add_data (x.i_a_buy5 ,5,OrdBuy, Book_Type_Implied,SecA)) )));
    (BookAction(ST_Add((mk_add_data (x.i_a_sell1,1,OrdSell,Book_Type_Implied,SecA)) )));
    (BookAction(ST_Add((mk_add_data (x.i_a_sell2,2,OrdSell,Book_Type_Implied,SecA)) )));
    (BookAction(ST_Add((mk_add_data (x.i_a_sell3,3,OrdSell,Book_Type_Implied,SecA)) )));
    ...
    (BookAction(ST_Add((mk_add_data (x.i_b_buy4 ,4,OrdBuy, Book_Type_Implied,SecB)) )));
    (BookAction(ST_Add((mk_add_data (x.i_b_buy5 ,5,OrdBuy, Book_Type_Implied,SecB)) )));
    (BookAction(ST_Add((mk_add_data (x.i_b_sell1,1,OrdSell,Book_Type_Implied,SecB)) )));
    (BookAction(ST_Add((mk_add_data (x.i_b_sell2,2,OrdSell,Book_Type_Implied,SecB)) )));
    (BookAction(ST_Add((mk_add_data (x.i_b_sell3,3,OrdSell,Book_Type_Implied,SecB)) )));
