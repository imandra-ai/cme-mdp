...
let search_space_to_list x = [
    ...
    BookAction(ST_Change(make_ord_change_data(SecA,Book_Type_Implied,1,OrdBuy,x.oc_new_qty_41)));
    ...
    BookAction(ST_Change(make_ord_change_data(SecB,Book_Type_Implied,2,OrdBuy,x.oc_new_qty_63)));
...
let write_jsons m =
    ...
    packets |> packets_to_json
            ...
            |> Yojson.Basic.to_file (Printf.sprintf "generated/test_f634fd18d963b0fd623a15ab30e28d2a_%d.json" !n) 
;;
:shadow on
:adts on
