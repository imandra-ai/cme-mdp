...
let search_space_to_list x = [
    ...
    BookAction(ST_Change(make_ord_change_data(SecB,Book_Type_Multi,2,OrdBuy,x.oc_new_qty_73)));
...
let write_jsons m =
    ...
    packets |> packets_to_json
            ...
            |> Yojson.Basic.to_file (Printf.sprintf "generated/test_c852e83482816077ed9b21e879417e55_%d.json" !n) 
;;
:shadow on
:adts on
