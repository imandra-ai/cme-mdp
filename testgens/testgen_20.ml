...
let search_space_to_list x = [
    ...
    BookAction(ST_Delete(make_ord_del_data(SecA,Book_Type_Multi,OrdSell,x.od_level_num_84)));
...
let write_jsons m =
    ...
    packets |> packets_to_json
            ...
            |> Yojson.Basic.to_file (Printf.sprintf "generated/test_79375af4a7336af9a410ce4151ead7ae_%d.json" !n) 
;;
:shadow on
:adts on
